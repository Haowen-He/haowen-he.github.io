...
<img src="https://haowen-he.github.io/images/filenamehere.gif?raw=true" alt="" width="32%" align="left" /> Cyanobacterial harmful algal blooms, also referred to as blue-green algae, are common photosynthetic bacteria that live in surface waters. While we know of many factors that may contribute to CyanoHABs, how these factors come together to create a bloom of algae is not well understood. <br> <br> I'm interested in modeling factors that contribute to cyanobacterial harmful algal blooms using statistics & data science techniques.
